                ...
                <div class="col">
                    <div class="card d-flex justify-content-center align-items-center">
                        <div class="card-body d-flex flex-column justify-content-center align-items-center">
                            <h3 class="card-title"><a class="text-decoration-none" href="{{ route('products.showOneById', $product->id) }}">{{ ucfirst($product->name) }}</a></h3>
                            ...
                            <h6 class="card-title"><a class="text-decoration-none" href="{{ route('products.showOneById', $product->id) }}">Voir la fiche produit</a></h6>
                        </div>
                    </div>
                </div>
            @endforeach
